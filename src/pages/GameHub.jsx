  ...
  useEffect(() => {
    ...
    const updateLeaderboard = () => {
      ...
      const dummyLeaderboard = [
        { name: 'Tipendra', game: 'Market Predictor', score: 95, totalXP: 950, gamesCompleted: 6, avgScore: 92 },
        { name: 'Sonalika', game: 'Debt Destroyer', score: 88, totalXP: 880, gamesCompleted: 6, avgScore: 85 },
        { name: 'Rashi', game: 'Credit Quest', score: 91, totalXP: 910, gamesCompleted: 6, avgScore: 88 },
        { name: 'Swara', game: 'Savings Sprint', score: 86, totalXP: 860, gamesCompleted: 5, avgScore: 83 },
        { name: 'Ansh', game: 'Needs vs Wants', score: 89, totalXP: 890, gamesCompleted: 6, avgScore: 87 }
      ];
